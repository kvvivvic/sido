...
const ICON_CLASS = "transiton-all cursor-pointer hover:text-indigo-400 hover:scale-105 mx-1";
const CartItem = ({ product, product: { id, image, title, option, quantity, price } }) => {
