    ...
    <>
      <section className="flex flex-col md:flex-row p-4">
        ...
        <div className="w-full basis-5/12 md:pl-12 flex flex-col p-4 pt-4 md:pt-24">
          <p className=" w-20 text-center inline-block border bg-indigo-400 text-white font-bold text-sm px-2 py-1 rounded-lg font-lato">{category}</p>
          ...
          <label htmlFor="select" className="font-lato text-indigo-400 font-bold">
            Option :
          </label>
          <select className="font-lato p-2 m-4 border-2 border-dashed border-indigo-400 outline-none" id="select" onChange={handleSelect} value={selected}>
